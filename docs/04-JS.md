...
- $request.body<string|buffer> : 当数据类型为 protobuf 时对应为 buffer(v3.7.5)，其他情况下为 string
...
- $response.body<string|buffer> : 当数据类型为 protobuf 时对应为 buffer(v3.7.5)，其他情况下为 string
