...
*以下内容主要为 elecV2P 的脚本编写指导，普通用户可直接跳过。*
...
``` JS
$evui({
  title: 'elecV2P windows',
  width: 800,
  height: 600,
  content: "<p>显示一张图片</p><img src='https://raw.githubusercontent.com/elecV2/elecV2P-dei/master/docs/res/overview.png'>",
